...
public class RETC_044 {
	...
	public void f() throws Exception {
		...
		loginPOM.addFeaturesProperty();
		System.out.println("New feature is getting added....");
		//driver.navigate().to("http://realestate.upskills.in/wp-admin/post-new.php?post_type=property");
		driver.navigate().forward();
		loginPOM.addFeatureName("New Feature Launch");
		loginPOM.addFeatureSlug("New-Feature");
		loginPOM.addFeatureDescription("New Launches of villas, apartments, flats");
		//loginPOM.defaultFrame();
		loginPOM.addNewFeature();
		System.out.println("New feature is added and published....");
